<header id="header" class="full-header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="index/images/logo-dark.png"><img src="index/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="index/images/logo-dark2x.png"><img src="index/images/logo2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
